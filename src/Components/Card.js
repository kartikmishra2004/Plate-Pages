            ...
            <div onMouseEnter={handleDisplayBtnHide} onMouseLeave={handleDisplayBtnShow} className="card md:w-[330px] w-[300px]">
                ...
                <div className="card__content">
                    ...
                    <div className="btns flex flex-col justify-center">
                        <Link target='_blank' rel='noreferrer' className={`${displayBtn} md:block text-white bg-[#14b8a6] hover:bg-[#089686] font-2 rounded-lg text-sm px-5 py-2.5 me-2 text-center mb-2`} to={props.foodRecipe}>View full recipe 👁️</Link>
                        <Link target='_blank' rel='noreferrer' className={`${displayBtn} md:block text-white bg-[#d32f26] hover:bg-[#b3261e] font-2 rounded-lg text-sm px-5 py-2.5 me-2 text-center`} to={props.foodVideo}>Watch video ▶</Link>
                    </div>
                </div>
            </div>
